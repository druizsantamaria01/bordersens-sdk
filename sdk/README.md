...
- [BorderSensSDK-2.0.5-jar-with-dependencies.jar](./BorderSensSDK-2.0.5-jar-with-dependencies.jar): Librería [BorderSensSDK](./BorderSensSDK) compilada en forma de jar, para poder ser usada en otros proyectos java.
